...
output = tf.keras.layers.Dense(2, activation='sigmoid',trainable=True, name='output') (z)
...
precision_score(yo, yp, labels=[0,1],average='micro',zero_division=0)

from sklearn.metrics import recall_score
recall_score(yo, yp, labels=[0,1],average='micro',zero_division=0)

from sklearn.metrics import f1_score
f1_score(yo, yp, labels=[0,1], average='micro',zero_division=0)
...
plt.savefig('2-class-confusion.png', dpi=500)
plt.show()
...
model1.save('Models/ Binary model.h5')